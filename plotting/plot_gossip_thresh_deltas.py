...
#delta_tick=["0", "1", "2", "3", "4", "5", "6", "7", "8"]
delta_tick=["0", "4", "8", "12", "16", "20"] #, "24", "28", "32", "64"]
run_tick=["0", "1", "2", "3", "4"]
#rate="32k"
...
for delta in delta_tick:
    ...
    for run in run_tick:
        ...
        filename_prefix = method_tick[method_index] + "_d" + delta + "_run" + run
        ...
        print( "method:" + method_tick[method_index] + ",rate:" + rate + ",delta:" + delta + "run:" + run) 
...
mean_per_delta_mean_array = np.zeros(len(delta_tick))
np.put(mean_per_delta_mean_array, np.arange(len(delta_tick)), mean_mean)
mean_per_delta_sem_array = np.zeros(len(delta_tick))
np.put(mean_per_delta_sem_array, np.arange(len(delta_tick)), mean_sem)

pct95th_per_delta_mean_array = np.zeros(len(delta_tick))
np.put(pct95th_per_delta_mean_array, np.arange(len(delta_tick)), pct95th_mean)
pct95th_per_delta_sem_array = np.zeros(len(delta_tick))
np.put(pct95th_per_delta_sem_array, np.arange(len(delta_tick)), pct95th_sem)

pct99th_per_delta_mean_array = np.zeros(len(delta_tick))
np.put(pct99th_per_delta_mean_array, np.arange(len(delta_tick)), pct99th_mean)
pct99th_per_delta_sem_array = np.zeros(len(delta_tick))
np.put(pct99th_per_delta_sem_array, np.arange(len(delta_tick)), pct99th_sem)

pct99th9_per_delta_mean_array = np.zeros(len(delta_tick))
np.put(pct99th9_per_delta_mean_array, np.arange(len(delta_tick)), pct99th9_mean)
pct99th9_per_delta_sem_array = np.zeros(len(delta_tick))
np.put(pct99th9_per_delta_sem_array, np.arange(len(delta_tick)), pct99th9_sem)
