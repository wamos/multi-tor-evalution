...
fig_xlabel  = "Gossip Threshold(RPS}"
...
#Qrate_tick =[ "20k", "23k", "25k", "28k", "30k", "33k", "35k"]
...
#gossip_load_thresh = ["0", "1", "2", "4", "8"]
#gossip_load_thresh = ["4"]
...
for method in method_tick:
    ...
    for gossip in gossip_load_thresh:
        ...
        for run in run_tick:
            ...
            filename_prefix = method_tick[method_index] + "_gth" + gossip + "_run" + run
